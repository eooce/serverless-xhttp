...
// 环境变量
const UUID = process.env.UUID || 'fa81709f-c3d8-4e4c-8bd9-0502dc78eec8'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'ip.086571.xyz:8008';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'YiSBm5Hzzl9AadRQjLcHymN2WoZTR6hk';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
...
const DOMAIN = process.env.DOMAIN || 'xiluowei-helloworld.hf.space';                   // 域名或ip,留空将自动获取服务器ip
